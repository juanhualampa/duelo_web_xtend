...
.service('DuelosService',function(){
	...
	//this.datosDelJuego=function(idParticipanteUno){
		return {
	...
	/*
	// esto no se si esta bien, pero lo agrego para probar...
	this.datosDelJuego=function(idParticipanteDos){
		return {
			//las posiciones deberian estar aparte para todo el juego y no por jugador
			//posicionesDuelos: [ {nombre:'TOP'}, {nombre:'BOTTOM'}, {nombre:'JUNGLE'},{nombre:'MIDDLE'}],
			personajes:[ 
			{
				id:7, 
